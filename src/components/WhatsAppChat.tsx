...
const WhatsAppChat = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 bg-[#25D366] text-white p-4 rounded-full shadow-xl hover:bg-[#128C7E] transition-all duration-300 z-50 flex items-center gap-3 group"
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span className="hidden md:block text-lg font-semibold pr-2">Chat with us</span>
      </div>
